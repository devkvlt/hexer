...
var green = cli.Command{
	Name:        "green",
	Usage:       "Get the green component",
	Description: "Get the (0-255)-based green component of the input color in the RGB model.",
	UsageText:   "hexer green <color>",

...
var setr = cli.Command{
    Name:        "setr",
	Usage:       "Set the red component",
	Description: "Set the (0-255)-based red component of the input color in the RGB model.",
    UsageText:   "hexer setr <color> <value>",
